...
_null = [HC, [_smuggleGroup, _infteamPatrol, _indSniperTeam, _SMvehPatrol, _SMaaPatrol]] execVM ""scripts\HC\setowner.sqf""; player sideChat format[""Transferred %1 units to HC"", OC_pass];