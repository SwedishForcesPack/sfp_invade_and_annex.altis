...
//NORRN_player_units = [s1,s2,m1,p1,p2,a1,a2,a3,a4,a5,a6,a7,a8,b1,b2,b3,b4,b5,b6,b7,b8,c1,c2,c3,c4,c5,c6,c7,c8,d1,d2,d3,d4,d5,d6,d7,d8];
// ==================================================================
// WELCOME SCREEN
...
// ==================================================================
// REVIVE OPTIONS
_max_respawns 					= (paramsArray select 4);			//array no.38 - Number of lives per unit
_JIP_respawns					= [2,30];			//array no.63 - 0 - off or the number of lives players receive when they JIP , JIP time after the mission starts
...
_Base_1 						= "Airfield";			//array no.13 - spawn position names
_Base_2 						= "Mobile";		//array no.14
_Base_3 						= "";				//array no.15
_Base_4 						= "";				//array no.16
_Base_free_respawn 				= [1,1,0,0];		//array no.36 - allow spawning at spawn points even if enemy troops are present (options OFF = 0, ON = 1)
_respawn_at_base_addWeapons 	= 0;				//array no.11 - unit respawns with weapons it commenced the mission with
_respawn_at_base_assItems 		= [];				//array no.34 - Array with respawn at base assigned items
_respawn_at_base_allItems		= [];				//array no.35 - Array with respawn at base other items format (see readMe for array format details)
...
_mobile_man 					= objNull;  				//array no.53 - place name of unit here or if not used make sure set as objNull //s1
// ==================================================================
// UNITS THAT CAN REVIVE/UNITS THAT CAN BE REVIVED
_can_revive 					= "B_medic_F";//array no.18
_can_revive_2 					= "";				//array no.19
_can_be_revived 				= "B_Soldier_base_F";//array no.20
_can_be_revived_2 				= "";				//array no.21
_medic_1						= "B_medic_F";		//array no.76 - Used in conjunction with medpacks and bleeding
...
_medic_medpacks 				= 5;				//array no.83 - No of medpacks as specified in _medic variables - required for reviving units
_unit_medpacks 					= 0;				//array no.84 - No of medpacks as specified in _can_revive variables - required for reviving units
...
_allied_side_2 					= "WEST";			//array no.43 - If all players are from the same side - set the same side for both variables eg "WEST", "WEST"
// ==================================================================
// UNCONSCIOUS CAMERA OPTIONS
_follow_cam 					= 1;				//array no.5  - option to allow viewing of friendly units while unconscious
_follow_cam_distance			= 100;				//array no.32 - the range that unconscious players can spectate friendly units
...
_top_view_height 	   			= 50;				//array no.55 - allows you to set the top down camera height
...
_respawn_button_timer 			= 0;				//array no.25 - Time until respawn button appears (0 = approx. 12 seconds), NB: Can be set to a high number
...
_all_dead_distance 				= 10000;			//array no.57 - does a respawn dialog appear when all players within a specified distance are unconscious
// ==================================================================
...
_upper_bound_heal 				= 0.6;				//array no.31
// ==================================================================
...
// =====================================================================================================================
//Undefined variables NOT IMPLEMENTED or no longer used but needed to maintain the integrity of the scripts
...
_dualTimer						= 0;				//array no.67 - NOT IMPLEMENTED - normal units can only revive for eg 30 seconds whereas medics can heal
