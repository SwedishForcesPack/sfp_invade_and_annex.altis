...
_heavyCant = ["C_Van_01_box_F","O_MBT_02_arty_F","O_APC_Tracked_02_cannon_F","O_APC_Wheeled_02_rcws_F","O_MBT_02_cannon_F","O_APC_Tracked_02_AA_F","B_APC_Tracked_01_AA_F","B_MBT_01_arty_F","B_MBT_01_mlrs_F","B_Truck_01_ammo_F"];
...
if((_helo isKindOf "Heli_Transport_01_base_F") OR (_helo isKindOf "I_Heli_light_03_F")) then {_cantLift = _mediumCant};
