...
superheavy = ["B_MBT_01_cannon_F","B_MBT_01_arty_F","I_MBT_03_cannon_F","sfp_strv122"];
heavy = ["sfp_strf90c","sfp_strf90c","sfp_patgb203","I_APC_tracked_03_cannon_F","I_APC_Wheeled_03_cannon_F","sfp_lvkv90c"];
medium = ["C_Van_01_fuel_F","sfp_tgb16","sfp_tgb16_rws","B_MRAP_01_gmg_F","I_MRAP_03_F","I_MRAP_03_hmg_F","I_MRAP_03_gmg_F","B_UGV_01_F","B_UGV_01_rcws_F","B_G_Offroad_01_F","B_G_Offroad_01_armed_F","B_Boat_Armed_01_minigun_F","B_SDV_01_F"];
