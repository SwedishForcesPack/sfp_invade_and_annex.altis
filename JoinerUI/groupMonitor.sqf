...

      {
           ...
           Else

            {
                    ...
                    deleteGroup Alpha;
                    Alpha=Nil;
                    Alpha = CreateGroup West;HintSilent "You've created group Alpha as the leader";
                    publicvariable "Alpha";
                    };
...

      {
		 ...
		 If (Count Units Bravo == 0) Then 
             ...
             
             {
   	            ...
   	            deleteGroup Bravo;
                    Bravo=Nil;
                    Bravo = CreateGroup West;HintSilent "You've created group Bravo as the leader";
                    publicvariable "Bravo";
                    };
           ...
           Else

            {
             ...
             
             {
   		    ...
   		    deleteGroup Charlie;
                    Charlie=Nil;
                    Charlie = CreateGroup West;HintSilent "You've created group Charlie as the leader";
                    publicvariable "Charlie";
                    };
           ...
           Else

            {
   ...
   
             {
   	            ...
   	            deleteGroup Delta;
                    Delta=Nil;
                    Delta = CreateGroup West;HintSilent "You've created group Delta as the leader";
                    publicvariable "Delta";
                    };
