...
tcb_ais_medical_education		=	2;				//	Who can revive a concious unit?	0 == everybody		1 == everybody with a firstaid or medikit		2 == only medics 	(affect both, AI and players!)
...
tcb_ais_random_lifetime_factor 	= 	175;			//	a higher value means you got more time to heal the unit before bleeding out and die (50 == means round about 1 minute, 100 == means round about 3 minutes, 200 == approximately 8 minutes)
