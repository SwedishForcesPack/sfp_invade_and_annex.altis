...
[_unit] execVM "vehicle\setupUnit.sqf";
...
{	
	...
	{	
		...
		[[[_unit],"vehicle\setupUnit.sqf"],"BIS_fnc_execVM",nil,true] spawn BIS_fnc_MP;
		//if(isServer) then {[_unit] execVM "scripts\markerFollow.sqf"};
