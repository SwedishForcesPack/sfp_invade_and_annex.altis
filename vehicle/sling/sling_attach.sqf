call compile preprocessFile "vehicle\sling\sling_config.sqf";
...
if(({_closestUnitType == _x} count _liftable) < 1) exitWith{hint "Slinging not allowed";};
...
[_helo] execVM "vehicle\sling\sling_heightDisplay.sqf";
